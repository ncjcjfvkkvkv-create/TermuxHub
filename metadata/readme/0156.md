...
> [!WARNING]
> Deprecated: use [**`-output-template`**](https://raw.githubusercontent.com/projectdiscovery/katana/dev/#-output-template) instead. The field flag is still supported for backward compatibility.
...
In this example, `email` represents a [custom field](https://raw.githubusercontent.com/projectdiscovery/katana/dev/#custom-fields) that extracts and displays email addresses found within the source `url`.
...
katana is made with ❤️ by the [projectdiscovery](https://projectdiscovery.io) team and distributed under [MIT License](https://raw.githubusercontent.com/projectdiscovery/katana/dev/LICENSE.md).
