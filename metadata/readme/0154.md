...
[![](https://raw.githubusercontent.com/hahwul/dalfox/main/docs/static/images/CONTRIBUTORS.svg)](https://github.com/hahwul/dalfox/graphs/contributors)

## About the Name
As for the name, Dal([달](https://en.wiktionary.org/wiki/달)) is the Korean word for "moon," while "Fox" stands for "Finder Of XSS" or 🦊

![](https://raw.githubusercontent.com/hahwul/dalfox/main/docs/images/illust.jpg)
