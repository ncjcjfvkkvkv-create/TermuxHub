...
* [Fuzzy completion](https://raw.githubusercontent.com/junegunn/fzf/master/#fuzzy-completion)
    ...
    * [Fuzzy completion for Nushell](https://raw.githubusercontent.com/junegunn/fzf/master/#fuzzy-completion-for-nushell)
...
- Custom completers can be defined via the `$env.FZF_COMPLETERS` record in
  ...
  ```
  See [shell/completion-examples.nu](https://raw.githubusercontent.com/junegunn/fzf/master/shell/completion-examples.nu) for more
  examples.
